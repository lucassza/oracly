<x-filament-panels::page>
    ...
    <div class="grid gap-4 xl:grid-cols-3">
        @forelse ($cards as $index => $card)
            <article class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:!border-slate-700 dark:!bg-slate-950 dark:shadow-black/30">
                ...
                <div class="space-y-2">
                    @foreach ($card['actions'] as $action)
                        <div class="rounded-xl border border-gray-100 px-3 py-2 dark:!border-slate-700 {{ $loop->first ? 'bg-amber-50 dark:!border-amber-400/30 dark:!bg-amber-400/15' : 'bg-gray-50 dark:!bg-slate-900' }}">
